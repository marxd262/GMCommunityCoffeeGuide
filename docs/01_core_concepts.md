...
12. From about 5cm height use the blind shaker and let the grinds fall into the portafilter. I aim for a small mound in the middle
13. Check distribution in the portafilter. Like I said, I aim for a small mound in the middle. If needed I distribute by knocking the portafilter
...
24. I remove the portafilter, take the puckscreen and spring off
25. Knock the puck out and put the Portafilter back in
26. Enjoy the espresso

That sounds like a lot of steps and extras, but in the end it's a workflow that I find easy to replicate without thinking too much. Maybe you noticed that some steps that may be recommended seem to be missing. Like WDT, Distributor, flush after the shot. For me personally I noticed that they don't make a big difference.  
