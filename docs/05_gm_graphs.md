...
- [The Graph](#the-graph)
- [1. The Lables](#1-the-lables)
- [2. The Graph](#2-the-graph)
- [3. How to read a graph.](#3-how-to-read-a-graph)
- [4. Excample Disecting a Shot based on the Graph](#4-excample-disecting-a-shot-based-on-the-graph)
  - [4.1. Temp](#41-temp)
  - [4.2. Flow](#42-flow)
  - [4.3. Pressure](#43-pressure)
  - [4.4. Temperature and Flow](#44-temperature-and-flow)
  - [4.5. Flow and Pressure](#45-flow-and-pressure)
- [5. More Examples in a bit less detail](#5-more-examples-in-a-bit-less-detail)
  - [5.1. First Example](#51-first-example)
...
# 5. More Examples in a bit less detail
